defmodule FastsmsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FastsmsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FastsmsWeb.Gettext, "errors", msg, opts)
    end
  end
